...
public:
    ...
    void SetWindowSize(int windowID, int width, int height)override;
    void SetWindowPos(int windowID, int xpos, int ypos) override;
    void GetWindowSize(int windowID, int &width, int &height)override;
    void GetWindowPos(int windowID, int& xpos, int& ypos) override;
    int  GetWindowAttrib(int windowID, int attrib) override;
    void RestoreWindow(int windowID) override;
    void MaximizeWindow(int windowID) override;
